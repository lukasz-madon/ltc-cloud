...
sudo sh cuda_5.5.22_linux_64.run -silent -toolkit -driver 
...
nohup sh -c "/usr/bin/env LD_LIBRARY_PATH=/usr/local/cuda-5.5/lib64 ./cudaminer -o stratum+tcp://us3.wemineltc.com:3333 -u lukasgt.gpu4 -p gpu4 -C 1 &"
cd ~
...
cd ~/cpuminer/
./minerd -o http://127.0.0.1:8332 -u lukasgt.cpu4 -p cpu4 -t 6