...
nohup sh -c "/usr/bin/env LD_LIBRARY_PATH=/usr/local/cuda-5.5/lib64 ./cudaminer -o stratum+tcp://us3.wemineltc.com:3333 -u lukasgt.gpu2 -p gpu2 -C 1 &" >/dev/null 2>&1
# proxy
cd ~
...
nohup sh -c "./mining_proxy.py -o stratum2.wemineltc.com -p 3333 &" >/dev/null 2>&1
# CPU miner
cd ~
...
./configure CFLAGS="-O3"
make
nohup sh -c "./minerd -o http://127.0.0.1:8332 -u lukasgt.cpu2 -p cpu2 -t 6 &" >/dev/null 2>&1